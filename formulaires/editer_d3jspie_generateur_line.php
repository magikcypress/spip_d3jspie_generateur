...
/**
 * Chargement du formulaire de configuration des d3jspie_generateur_line
 *
 * @return array
...
/**
 * Vérifications du formulaire de configuration des d3jspie_generateur_line
 *
 * @return array
 *     Tableau des erreurs
**/
function formulaires_editer_d3jspie_generateur_line_verifier_dist($id_d3jspie_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3jspie_generateur_line_verifier_2_dist($id_d3jspie_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3jspie_generateur_line_verifier_3_dist($id_d3jspie_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3jspie_generateur_line_verifier_4_dist($id_d3jspie_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3jspie_generateur_line_verifier_6_dist($id_d3jspie_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
 ...
 *     Tableau des erreurs
**/
function formulaires_editer_d3jspie_generateur_line_verifier_7_dist($id_d3jspie_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
	$erreurs = array();
...
/**
 * Traitement du formulaire de configuration des d3jspie_generateur_line
 *
 * @return array
 *     Retours du traitement
**/
function formulaires_editer_d3jspie_generateur_line_traiter_dist($id_d3jspie_generateur='new', $objet='', $id_objet='', $retour='', $ajaxload='oui', $options=''){
