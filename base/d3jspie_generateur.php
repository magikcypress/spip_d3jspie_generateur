...
function d3jspie_generateur_declarer_tables_objets_sql($tables){
	...
	$tables['spip_d3jspie_generateur'] = array(
		...
		'field'=> array(
			...
			"dimension_canvasTop" => "varchar(255) NOT NULL",
			"dimension_canvasBottom" => "varchar(255) NOT NULL",
			"dimension_canvasRight" => "varchar(255) NOT NULL",
			"dimension_canvasLeft" => "varchar(255) NOT NULL",
			"rotation_yaxis" => "varchar(255) NOT NULL",
			...
			"bulle_background" => "varchar(255) NOT NULL",
			"bulle_border" => "varchar(255) NOT NULL",
			"bulle_color" => "varchar(255) NOT NULL",
			"bulle_z_index" => "varchar(255) NOT NULL",
